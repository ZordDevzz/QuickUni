...
import { employee, gradeAudit, grade, account, notificationRecipient, notification, featureFlagAudit, featureFlag, assignment, enrollment, gradeType, courseClass, enrollStatus, student, userDeviceToken, semester, registrationPeriod, knowledgeBlock, chatGroup, groupRole, scholarshipPolicy, studentScholarship, invoiceDetail, invoice, transaction, courseClassType, subject, major, curriculum, tuitionFeeConfig, schedule, room, scheduleStatus, scheduleType, systemAuditLog, chatGroupMember, notificationTemplate, profile, profileSchema, message, building, courseMaterial, systemSetting, department, educationType, mainClass, groupAuthority, groupRoleAuthority, messageRead, userSystemRole, systemRole, systemAuthority, systemRoleAuthority, memberRole, profileField, profileSchemaField, subjectPrerequisite, systemBroadcastRead, systemBroadcast, mainClassMember, classRole, userNotificationSetting, curriculumSubject, departmentEmployment, attendanceStatus } from "./schema";
...
export const notificationRecipientRelations = relations(notificationRecipient, ({one}) => ({
	account: one(account, {
...
export const userDeviceTokenRelations = relations(userDeviceToken, ({one}) => ({
	account: one(account, {
...
export const registrationPeriodRelations = relations(registrationPeriod, ({one}) => ({
	semester: one(semester, {
...
export const knowledgeBlockRelations = relations(knowledgeBlock, ({one, many}) => ({
...
export const studentScholarshipRelations = relations(studentScholarship, ({one}) => ({
...
export const scholarshipPolicyRelations = relations(scholarshipPolicy, ({many}) => ({
	studentScholarships: many(studentScholarship),
}));
...
export const courseClassTypeRelations = relations(courseClassType, ({many}) => ({
	courseClasses: many(courseClass),
}));
...
export const tuitionFeeConfigRelations = relations(tuitionFeeConfig, ({one}) => ({
	major: one(major, {
...
export const scheduleStatusRelations = relations(scheduleStatus, ({many}) => ({
	schedules: many(schedule),
}));
...
export const chatGroupMemberRelations = relations(chatGroupMember, ({one, many}) => ({
	chatGroup: one(chatGroup, {
...
export const groupRoleAuthorityRelations = relations(groupRoleAuthority, ({one}) => ({
...
export const groupAuthorityRelations = relations(groupAuthority, ({many}) => ({
	groupRoleAuthorities: many(groupRoleAuthority),
}));
...
export const systemRoleAuthorityRelations = relations(systemRoleAuthority, ({one}) => ({
...
export const systemAuthorityRelations = relations(systemAuthority, ({many}) => ({
	systemRoleAuthorities: many(systemRoleAuthority),
}));
...
export const profileSchemaFieldRelations = relations(profileSchemaField, ({one}) => ({
...
export const subjectPrerequisiteRelations = relations(subjectPrerequisite, ({one}) => ({
...
export const systemBroadcastReadRelations = relations(systemBroadcastRead, ({one}) => ({
	account: one(account, {
...
export const systemBroadcastRelations = relations(systemBroadcast, ({many}) => ({
	systemBroadcastReads: many(systemBroadcastRead),
}));

export const mainClassMemberRelations = relations(mainClassMember, ({one}) => ({
...
export const curriculumSubjectRelations = relations(curriculumSubject, ({one}) => ({
...
export const departmentEmploymentRelations = relations(departmentEmployment, ({one}) => ({
	department: one(department, {
...
export const attendanceStatusRelations = relations(attendanceStatus, ({one}) => ({
	enrollment: one(enrollment, {
